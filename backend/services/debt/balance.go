...
//
// Fase 6 (Blueprint §19.6, §22): "AND p.voided_at IS NULL" / "AND voided_at IS NULL" agregados junto
// a los ya existentes "deleted_at IS NULL" — un pago anulado deja de contar aquí, y por lo tanto
// tampoco en EffectiveBalance (que delega 100% en esta función, sin cambio propio necesario).
